...
**Model Training:**
kNN-5 k-Nearest Neighbors is a simple algorithm that stores all available cases and classifies new cases based on a similarity measure (e.g., distance functions). In the model training phase, we utilized the k-Nearest Neighbors (kNN) algorithm with k=5 (denoted as kNN-5)
